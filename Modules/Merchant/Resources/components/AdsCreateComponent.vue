<template>
    <div class="ads-image-upload">
        <form @submit.prevent="createAds" @keydown="ads_form.onKeydown($event)" enctype="multipart/form-data">
            ...
            <div class="img-block">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="input-info">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" :class="{ 'is-invalid': ads_form.errors.has('file') }" name="file" accept="image/jpg,image/png,image/jpeg"
                                    id="image"
                                    @change="getImage">
                    ...
                    <div class="col-lg-3">
                        <figure>
                            <img :src="adsImage ? adsImage : 'data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D'" alt="Ads Image" class="mb-3">
                        </figure>
                    </div>
                </div>
            </div>
            <button type="submit" class="btn btn-facebook btn-block">
                <i class="fas fa-check"></i> Tạo quảng cáo
            </button>
        </form>
    </div>
</template>
