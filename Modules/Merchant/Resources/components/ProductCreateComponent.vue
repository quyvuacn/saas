<template>
    <div class="product-image-upload">
        <form @submit.prevent="createProduct" @keydown="product_form.onKeydown($event)" enctype="multipart/form-data">
            <input type="hidden" name="create" value="true">
            <div class="img-block">
                <div class="input-info">
                    <div class="form-group">
                        <label for="name">Tên sản phẩm</label>
                        <input type="text" name="name" v-model="product_form.name" id="name" class="form-control" :class="{ 'is-invalid': product_form.errors.has('name') }" placeholder="Nhập tên sản phẩm của bạn">
                ...
                <figure>
                    <img :src="productImage ? productImage : 'data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D'" alt="Product Image" class="mb-3">
                </figure>
            </div>
            <div class="form-group">
                <label for="brief">Miêu tả ngắn về sản phẩm</label>
                <textarea name="brief" id="brief" class="form-control" rows="3" v-model="product_form.brief" :class="{ 'is-invalid': product_form.errors.has('brief') }"></textarea>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            createProduct() {
                this.product_form.post('/product/create', {
