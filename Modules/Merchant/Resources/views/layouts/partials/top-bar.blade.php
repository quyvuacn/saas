...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <?php */ ?>
        <?php
        $route['profile'] = route('merchant.account.profile');
        $route['setting'] = '#';
        //Priority = 0
        if (auth(ADMIN)->check()) {
        ...
        if (auth(MERCHANT)->check()) {
            ...
            $route['profile'] = route('merchant.account.profile');
            $route['setting'] = route('merchant.account.setting');
        }
        ?>
        <?php if (auth(MERCHANT)->check()): ?>
        ...
        <!-- Nav Item - User Information -->
            <li class="nav-item dropdown no-arrow">
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                    ...
                    @if (MerchantCan::do('setting.edit') && MerchantCan::do('isApproved'))
                        <a class="dropdown-item" href="{{$route['setting']}}">
                            <i class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i>
                            Cài đặt chung
                        </a>
                    @endif
                    <a class="dropdown-item" href="{{route('merchant.account.history')}}">
