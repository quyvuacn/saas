    ...
    <tr>
        <td bgcolor="#ffffff" style="padding: 100px 30px 100px 30px;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td align="center">
                        <h2>Yêu cầu trả máy bán hàng từ Merchant {{$merchant->name}}</h2>
                    </td>
                </tr>
                <tr>
                    <td>
                        Merchant {{$merchant->name}} vừa tạo yêu cầu trả máy bán hàng.
                        <br/>
                        Machine: {{$machine->name}}
                        <br/>
                        Address: {{$machine->machine_address}}
                        <br/>
                        Model máy: {{$machine->model}}
                        <br/>
                        Vui lòng kiểm tra và xác nhận.
                        <br/>
                        <a href="{{route("admin.machine.requestBackDetail", ['machineRequest' => $requestId])}}">Chi tiết</a>
                    </td>
                </tr>
                <tr>
                </tr>
