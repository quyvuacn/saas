    ...
    <tr>
        <td bgcolor="#ffffff" style="padding: 100px 30px 100px 30px;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td align="center">
                        <h2>Yêu cầu thêm mới máy bán hàng từ Merchant {{$merchant->name}}</h2>
                    </td>
                </tr>
                <tr>
                    <td align="center">
                        Merchant {{$merchant->name}} vừa yêu cầu cấp thêm {{$machineCount}} máy bán hàng.
                        <br/>
                        Vui lòng kiểm tra và xác nhận yêu cầu.
                        <br/>
                        <a href="{{route("admin.machine.requestDetail", ['merchantRequest' => $requestId])}}">Chi tiết</a>
                    </td>
                </tr>
                <tr>
                </tr>
