    ...
    <tr>
        <td bgcolor="#ffffff" style="padding: 100px 30px 100px 30px;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td align="center">
                        <h2>Yêu cầu đăng ký Merchant</h2>
                    </td>
                </tr>
                <tr>
                    <td>
                        Yêu cầu đăng ký tài khoản Merchant: {{$merchant->name}}
                        <br/>
                        Email: {{$merchant->email}}
                        <br/>
                        Phone: {{$merchant->phone}}
                        <br/>
                        Vui lòng kiểm tra và xác nhận request này.
                        <br/>
                        <a href="{{route("admin.merchant.request", ['merchantRequest' => $requestId])}}">Chi tiết</a>
                    </td>
                </tr>
                <tr>
                </tr>
