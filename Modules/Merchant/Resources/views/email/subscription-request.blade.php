    ...
    <tr>
        <td bgcolor="#ffffff" style="padding: 100px 30px 100px 30px;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td align="center">
                        <h2>Yêu cầu gia hạn thuê bao từ Merchant {{$merchant->name}}</h2>
                    </td>
                </tr>
                <tr>
                    <td>
                        Merchant {{$merchant->name}} vừa tạo yêu cầu gia hạn thuê bao.
                        <br/>
                        Tên máy: {{$subscription->machineSubscription->name}}
                        <br/>
                        Model máy: {{$subscription->machineSubscription->model}}
                        <br/>
                        Gia hạn thêm {{$subscription->request_month}} tháng
                        <br/>
                        Vui lòng kiểm tra và xác nhận yêu cầu.
                        <br/>
                        <a href="{{route("admin.subscription.approve", ['subscriptionRequest' => $requestId])}}">Chi tiết</a>
                    </td>
                </tr>
                <tr>
                </tr>
