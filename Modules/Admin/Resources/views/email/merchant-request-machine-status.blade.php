    ...
    <tr>
        <td bgcolor="#ffffff" style="padding: 100px 30px 100px 30px;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td align="center">
                        <h2>Duyệt yêu cầu cấp thêm máy bán hàng</h2>
                    </td>
                </tr>
                <tr>
                    <td>
                        Yêu cầu cấp thêm {{$merchantRequest->machine_request_count}} máy bán hàng của bạn đã được duyệt.
                        <br/>
                        Trạng thái hiện tại:
                        @if ($merchantRequest->status == 0)
                            Yêu cầu mới
                        @elseif($merchantRequest->status == 1)
                            Chờ ký hợp đồng
                        @elseif($merchantRequest->status == 2)
                            Chờ cài đặt máy
                        @elseif($merchantRequest->status == 3)
                            Đang bàn giao máy
                        @elseif($merchantRequest->status == 4)
                            Hoàn tất
                        @endif
                        <br/>
