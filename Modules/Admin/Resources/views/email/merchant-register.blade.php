    ...
    <tr>
        <td bgcolor="#ffffff" style="padding: 100px 30px 100px 30px;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td align="center">
                        <h2>Yêu cầu đăng ký Merchant của bạn đã được duyệt</h2>
                    </td>
                </tr>
                <tr>
                    <td>
                        Yêu cầu đăng ký tài khoản Merchant {{$merchantRequest->name}} cuả bạn đã được duyệt.
                        <br/>
                        Hãy đăng nhập ngay để sử dụng dịch vụ của chúng tôi.
                    </td>
                </tr>
            </table>
        </td>
