        ...
        <div class="col-lg-4 order-lg-2">
            <div class="card shadow mb-4">
                <div class="card-profile-image mt-4">
                    <figure class="rounded-circle avatar avatar font-weight-bold" style="font-size: 60px; height: 180px; width: 180px;" data-initial="{{substr($admin->name,0,1) ?? '---'  }}"></figure>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
...
{{--                        </div>--}}
        ...
        <div class="col-lg-8 order-lg-1">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.account.profile') }}" autocomplete="off">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group focused">
                                    ...
                                    <input type="text" id="name" class="form-control {{$errors->has('name')?'is-invalid':''}}" name="name" placeholder="Họ tên" value="{{ old('name',$admin->name) }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
